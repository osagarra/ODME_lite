...
###########################
    ...
    print "Accumulated error for sin:%r \t sout:%r" % mw.fitter_E.dist_check_s(x,y,lam,sout,sin,selfs)
    print "Accumulated error for E : %r " % mw.fitter_E.dist_check_E(x,y,lam,E,selfs)
